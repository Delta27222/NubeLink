...
public class Modal_Reporte_1 extends javax.swing.JDialog {
    ...
    public Modal_Reporte_1(JDialog padre, boolean modo) {
        super(padre,modo);
        initComponents();
    ...
    public Modal_Reporte_1(JDialog padre, boolean modo, String username) {
        super(padre,modo);
        initComponents();
        this.setLocationRelativeTo(null);
    ...
    private void initComponents() {
        ...
        jTable_Archivos1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id", "Hora", "Fecha", "Duración conexión"
            }
        ) {
        ...
        jLabel3.setText("    Reporte 1: Conexiones de administrador.");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Modal_Reporte_1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Modal_Reporte_1 dialog = new Modal_Reporte_1(new javax.swing.JDialog(), true);
